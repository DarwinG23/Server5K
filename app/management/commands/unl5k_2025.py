...
class Command(BaseCommand):
    ...
    EQUIPOS_DATOS = [
        ...
        (12, "Segundo Segund \"B\"", "estudiantes"),
        (13, "Odonto Runners", "estudiantes"),
        (14, "Los estratos", "estudiantes"),
        (15, "Titanes del zhamungui", "estudiantes"),
        (16, "Odontorunners", "estudiantes"),
        (17, "Los duros de la", "estudiantes"),
        (18, "DANU Atletas UNLIA", "estudiantes"),
